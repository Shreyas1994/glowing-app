...
namespace WindowsFormsApplication1
{
    public partial class Form13 : Form
    {
        ...
        "INSERT INTO served (" +
            ...
            ") VALUES (?,?,?,?,?)", con);
                top.Parameters.AddWithValue("?","H2");
            ...
            OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served where table_no='H2'", con1);
