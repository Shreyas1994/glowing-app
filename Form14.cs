...
namespace WindowsFormsApplication1
{
    public partial class Form14 : Form
    {
        ...
        "INSERT INTO served (" +
            ...
            ") VALUES (?,?,?,?,?)", con);
                top.Parameters.AddWithValue("?", "AC4");
            ...
            OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served where table_no ='AC4'", con1);
