    ...
    public partial class Form17 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            "INSERT INTO served (" +
                ...
                ") VALUES (?,?,?,?,?)", con);
                    top.Parameters.AddWithValue("?", "AC7");
                ...
                OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served where table_no ='AC7'", con1);
