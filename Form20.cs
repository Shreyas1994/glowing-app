    ...
    { OleDbConnection con = new OleDbConnection("Provider=Microsoft.Jet.OleDb.4.0;Data Source=D:/DB.mdb");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            "INSERT INTO served (" +
                ...
                ") VALUES (?,?,?,?,?)", con);
                    top.Parameters.AddWithValue("?", "AC10");
                    ...
                    top.Parameters.AddWithValue("?", 10);
                    top.ExecuteNonQuery();
                ...
                OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served where table_no ='AC10'", con1);
