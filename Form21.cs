    ...
    public partial class Form21 : Form
    {
        ...
        {      
            ...
            "INSERT INTO served (" +
                ...
                ") VALUES (?,?,?,?,?)", con);
                    top.Parameters.AddWithValue("?", "H1");
                ...
                OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served where table_no ='H1'", con1);
