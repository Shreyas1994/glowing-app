...
namespace WindowsFormsApplication1
{
    public partial class Form22 : Form
    {
        ...
        "INSERT INTO served (" +
            ...
            ") VALUES (?,?,?,?,?)", con);
                top.Parameters.AddWithValue("?", "H4");
           ...
           OleDbConnection con1 = new OleDbConnection("Provider=Microsoft.Jet.OleDb.4.0;Data Source=D:/DB.mdb");
            ...
            OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served where table_no ='H4'", con1);
