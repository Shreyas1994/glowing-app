...
namespace WindowsFormsApplication1
{
    public partial class Form11 : Form
    {
        ...
        public Form11()
        {
            ...
            OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served" + "'", con1);
        ...
        "INSERT INTO served (" +
            ...
            ") VALUES (?,?,?,?,?)", con);
                top.Parameters.AddWithValue("?", "AC2");
            ...
            con1.Open();
            DataSet dse = new DataSet();
            OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served where table_no ='AC2'", con1);
            adapReport.Fill(dse, "served");
            dataGridView2.AutoGenerateColumns = true;
            dataGridView2.DataSource = dse;
            dataGridView2.DataMember = "served";
