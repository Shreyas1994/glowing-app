...
namespace WindowsFormsApplication1
{
    public partial class Form28 : Form
    {
        ...
        "INSERT INTO served (" +
            ...
            ") VALUES (?,?,?,?,?)", con);
                top.Parameters.AddWithValue("?", "H10");
            ...
            OleDbDataAdapter adapReport = new OleDbDataAdapter("select item_name as [Item Name],qty as [QTY],w_id as [w_id] from served where table_no ='AC9'", con1);
